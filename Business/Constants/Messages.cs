namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string CreditCardListed = "Credit card listed successfully.";

        public static string CreditCardTypesListed = "Credit card types listed successfully.";
        public static string CreditCardTypeListed = "Credit card type listed successfully.";
        public static string CreditCardNotFound = "Credit card not found!";
        public static string CreditCardNumberNotMatching = "Card number does not match!";
        public static string CvcNotMatching = "CVC number does not match";
        public static string ExpirationDateNotMatching = "Expiration date does not match!";

        public static string UserCreditCardsListed = "Credit cards of user listed successfully.";
        public static string UserCreditCardListed = "Credit card of user listed successfully.";

        public static string CustomersListed = "Customers listed successfully.";
        public static string CustomerListed = "IndividualCustomer listed successfully.";
